        ...
        <div className="mt-8 grid md:grid-cols-[1fr_200px] gap-12 items-start">
          ...
          >
            ...
            <div className="relative">
              <div className="w-64 h-64 bg-charcoal-900 dark:bg-charcoal-950 rounded-xl border border-charcoal-700 shadow-2xl overflow-hidden">
                {/* Terminal Header */}
                ...
                {/* Terminal Content */}
                <div className="p-4 pb-8 font-mono text-sm space-y-1.5">
                  ...
                  <div className="text-teal-400 pl-2">3+ years in enterprise dev</div>
                </div>
              </div>
            </div>
          </motion.div>
